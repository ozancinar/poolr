...
test_that("meff() works correctly.", {
  ...
  expect_equivalent(m_nyh1, 21, tolerance = tol)
  expect_equivalent(m_lj1, 15, tolerance = tol)
  expect_equivalent(m_gao1, 20, tolerance = tol)
  expect_equivalent(m_gal1, 14, tolerance = tol)
  ...
  expect_equivalent(m_nyh2, 22, tolerance = tol)
  expect_equivalent(m_lj2, 21, tolerance = tol)
  expect_equivalent(m_gao2, 23, tolerance = tol)
  expect_equivalent(m_gal2, 20, tolerance = tol)
