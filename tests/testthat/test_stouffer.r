...
test_that("stouffer() works correctly with empirically-derived null distributions.", {
  ...
  expect_equivalent(c(res$statistic), 5.915392, tolerance = stat_tol * emp_sca)
  expect_equivalent(c(res$ci[1]), 0.0004404425, tolerance = stat_tol * emp_sca)
  expect_equivalent(c(res$ci[2]), 0.0007497133, tolerance = stat_tol * emp_sca)
  ...
  expect_equivalent(c(res$statistic), 5.915392, tolerance = stat_tol * emp_sca)
  expect_equivalent(c(res$ci[1]), 0.0006722326, tolerance = stat_tol * emp_sca)
  expect_equivalent(c(res$ci[2]), 0.0007786922, tolerance = stat_tol * emp_sca)
  ...
  expect_equivalent(c(res$statistic), 5.915392, tolerance = stat_tol * emp_sca)
  expect_equivalent(c(res$ci[1]), 0.0005988329, tolerance = stat_tol * emp_sca)
  expect_equivalent(c(res$ci[2]), 0.0009511528, tolerance = stat_tol * emp_sca)
